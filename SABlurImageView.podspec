...
Pod::Spec.new do |s|
  ...
  s.description      = <<-DESC
                       An optional longer description of SABlurImageView

                       * Markdown format.
                       * Don't worry about the indent, we strip it!
                       DESC
  s.homepage         = "https://github.com/<GITHUB_USERNAME>/SABlurImageView"
  # s.screenshots     = "www.example.com/screenshots_1", "www.example.com/screenshots_2"
  s.license          = 'MIT'
  s.author           = { "Taiki Suzuki" => "s1180183@gmail.com" }
  s.source           = { :git => "https://github.com/<GITHUB_USERNAME>/SABlurImageView.git", :tag => s.version.to_s }
